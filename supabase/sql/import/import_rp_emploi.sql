WITH d AS (
	SELECT "CODGEO",
		   regexp_replace('actifs_occupes_15ans_plus_p,' || "ACTOCC15P_P" || ',
						...
						non_salaries_15ans_plus_eployeurs_hommes_p,' || "HNSAL15P_EMPLOY_P" || ',
						...
						actifs_occupes_15_ans_plus_travaille_autre_region_en_metropole,' || "ACTOCC15P_ILT4_P" || ',
						actifs_occupes_15_ans_plus_travaille_autre_region_hors_metropole,' || "ACTOCC15P_ILT5_P" || ',
