WITH d AS (
	SELECT "CODGEO",
		   regexp_replace('pop_15_64_ans_p,' || "POP1564_P" || ',
						...
						emplois_salaries_au_lieu_travail_insdustrie_c,' || "INDUSLT_SAL_C" || ',
						emplois_salaries_au_lieu_travail_construction_c,' || "CONSTLT_SAL_C" || ',
						emplois_salaries_au_lieu_travail_c_commerce_transport_services,' || "CTSLT_SAL_C" || ',
						...
						emplois_salaries_au_lieu_travail_insdustrie_femmes_c,' || "INDUSLT_FSAL_C" || ',
						emplois_salaries_au_lieu_travail_construction_femmes_c,' || "CONSTLT_FSAL_C" || ',
						emplois_salaries_au_lieu_travail_c_commerce_transport_services_femmes,' || "CTSLT_FSAL_C" || ',
						...
						emplois_non_salaries_au_lieu_travail_insdustrie_c,' || "INDUSLT_NSAL_C" || ',
						emplois_non_salaries_au_lieu_travail_construction_c,' || "CONSTLT_NSAL_C" || ',
						emplois_non_salaries_au_lieu_travail_c_commerce_transport_services,' || "CTSLT_NSAL_C" || ',
						...
						emplois_non_salaries_au_lieu_travail_insdustrie_femmes_c,' || "INDUSLT_FNSAL_C" || ',
